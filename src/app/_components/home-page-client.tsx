...
import type { Auctioneer, Category, AuctionItem } from "@/lib/types";
import { ListFilter, Gavel } from "lucide-react";

interface HomePageClientProps {
  initialItems: AuctionItem[];
  initialCategories: Category[];
  initialAuctioneers: { id: string; name: string }[];
}

export function HomePageClient({ initialItems, initialCategories, initialAuctioneers }: HomePageClientProps) {
          ...
          <div className="w-full md:w-auto md:min-w-[200px]">
             <Select value={selectedAuctioneer} onValueChange={setSelectedAuctioneer}>
                ...
                <SelectContent>
                  ...
                  {initialAuctioneers.map((auctioneer) => (
