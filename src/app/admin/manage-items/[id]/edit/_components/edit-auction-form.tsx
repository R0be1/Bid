...
export function EditAuctionForm({ item, categories }: EditAuctionFormProps) {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      images: item.images.map((i) => ({ url: i.url })),
    },
  });
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        type="number"
                        step="0.01"
                        placeholder="Starting Price (Birr)"
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        type="number"
                        step="0.01"
                        placeholder="Participation Fee (Birr)"
                        {...field}
                      />
                    </FormControl>
                    <FormDescription>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        type="number"
                        step="0.01"
                        placeholder="Security Deposit (Birr)"
                        {...field}
                      />
                    </FormControl>
                    <FormDescription>
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          type="number"
                          step="0.01"
                          placeholder="Minimum Increment (Birr)"
                          {...field}
                        />
                      </FormControl>
                      <FormDescription>
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          type="number"
                          step="0.01"
                          placeholder="Max Allowed Value (Birr)"
                          {...field}
                        />
                      </FormControl>
                      <FormDescription>
