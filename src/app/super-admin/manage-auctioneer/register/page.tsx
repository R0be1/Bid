    ...
    <div className="space-y-8 p-4 md:p-8">
      <div>
        <h1 className="text-3xl font-bold font-headline text-primary">
          Register New Auctioneer
        </h1>
        <p className="text-muted-foreground">
          Create a new portal for an auctioneer.
        </p>
      </div>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 pb-8">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Information about the auctioneer's business.
              </CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                This user will manage the auctioneer portal. Their credentials
